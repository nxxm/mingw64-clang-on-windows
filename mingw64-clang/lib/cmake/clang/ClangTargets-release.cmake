...
set_target_properties(clangStaticAnalyzerCore PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangAST;clangASTMatchers;clangAnalysis;clangBasic;clangCrossTU;clangFrontend;clangLex;clangRewrite;clangToolingCore;LLVM"
...
set_target_properties(clangStaticAnalyzerFrontend PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangAST;clangASTMatchers;clangAnalysis;clangBasic;clangCrossTU;clangFrontend;clangLex;clangStaticAnalyzerCheckers;clangStaticAnalyzerCore;LLVM"
...
set_target_properties(clangTesting PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVM"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangTesting.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangTesting )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangTesting "${_IMPORT_PREFIX}/lib/libclangTesting.dll.a" "${_IMPORT_PREFIX}/bin/clangTesting.dll" )
...
# Import target "clangCXXProto" for configuration "Release"
set_property(TARGET clangCXXProto APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangCXXProto PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangCXXProto.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVM"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangCXXProto.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangCXXProto )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangCXXProto "${_IMPORT_PREFIX}/lib/libclangCXXProto.dll.a" "${_IMPORT_PREFIX}/bin/clangCXXProto.dll" )

# Import target "clangCXXLoopProto" for configuration "Release"
set_property(TARGET clangCXXLoopProto APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangCXXLoopProto PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangCXXLoopProto.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVM"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangCXXLoopProto.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangCXXLoopProto )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangCXXLoopProto "${_IMPORT_PREFIX}/lib/libclangCXXLoopProto.dll.a" "${_IMPORT_PREFIX}/bin/clangCXXLoopProto.dll" )

# Import target "clangProtoToCXX" for configuration "Release"
set_property(TARGET clangProtoToCXX APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangProtoToCXX PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangProtoToCXX.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangCXXProto;LLVM"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangProtoToCXX.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangProtoToCXX )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangProtoToCXX "${_IMPORT_PREFIX}/lib/libclangProtoToCXX.dll.a" "${_IMPORT_PREFIX}/bin/clangProtoToCXX.dll" )

# Import target "clangLoopProtoToCXX" for configuration "Release"
set_property(TARGET clangLoopProtoToCXX APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangLoopProtoToCXX PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangLoopProtoToCXX.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangCXXLoopProto;LLVM"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangLoopProtoToCXX.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangLoopProtoToCXX )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangLoopProtoToCXX "${_IMPORT_PREFIX}/lib/libclangLoopProtoToCXX.dll.a" "${_IMPORT_PREFIX}/bin/clangLoopProtoToCXX.dll" )

# Import target "clangLoopProtoToLLVM" for configuration "Release"
set_property(TARGET clangLoopProtoToLLVM APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangLoopProtoToLLVM PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangLoopProtoToLLVM.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangCXXLoopProto;LLVM"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangLoopProtoToLLVM.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangLoopProtoToLLVM )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangLoopProtoToLLVM "${_IMPORT_PREFIX}/lib/libclangLoopProtoToLLVM.dll.a" "${_IMPORT_PREFIX}/bin/clangLoopProtoToLLVM.dll" )

# Import target "clangFuzzerInitialize" for configuration "Release"
set_property(TARGET clangFuzzerInitialize APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(clangFuzzerInitialize PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangFuzzerInitialize.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVM"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/clangFuzzerInitialize.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangFuzzerInitialize )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangFuzzerInitialize "${_IMPORT_PREFIX}/lib/libclangFuzzerInitialize.dll.a" "${_IMPORT_PREFIX}/bin/clangFuzzerInitialize.dll" )
