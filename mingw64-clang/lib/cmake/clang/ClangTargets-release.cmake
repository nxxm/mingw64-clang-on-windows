...
set_target_properties(clangBasic PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangBasic.dll"
  )
...
set_target_properties(clangAPINotes PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangAPINotes.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangBasic;LLVMSupport"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangAPINotes.dll"
  )
...
set_target_properties(clangLex PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangBasic;LLVMSupport"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangLex.dll"
  )
...
set_target_properties(clangParse PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangParse.dll"
  )
...
set_target_properties(clangAST PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangAST.dll"
  )
...
set_target_properties(clangDynamicASTMatchers PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangDynamicASTMatchers.dll"
  )
...
set_target_properties(clangASTMatchers PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangASTMatchers.dll"
  )
...
set_target_properties(clangCrossTU PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangCrossTU.dll"
  )
...
set_target_properties(clangSema PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangSema.dll"
  )
...
set_target_properties(clangCodeGen PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangCodeGen.dll"
  )
...
set_target_properties(clangAnalysis PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangAnalysis.dll"
  )
...
set_target_properties(clangEdit PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangEdit.dll"
  )
...
set_target_properties(clangRewrite PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangRewrite.dll"
  )
...
set_target_properties(clangARCMigrate PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangARCMigrate.dll"
  )
...
set_target_properties(clangDriver PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangDriver.dll"
  )
...
set_target_properties(clangSerialization PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangSerialization.dll"
  )
...
set_target_properties(clangRewriteFrontend PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangRewriteFrontend.dll"
  )
...
set_target_properties(clangFrontend PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangFrontend.dll"
  )
...
set_target_properties(clangFrontendTool PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangFrontendTool.dll"
  )
...
set_target_properties(clangToolingCore PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangToolingCore.dll"
  )
...
set_target_properties(clangToolingInclusions PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangToolingInclusions.dll"
  )
...
set_target_properties(clangToolingRefactoring PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangToolingRefactoring.dll"
  )
...
set_target_properties(clangToolingASTDiff PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangToolingASTDiff.dll"
  )
...
set_target_properties(clangToolingSyntax PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangToolingSyntax.dll"
  )
...
set_target_properties(clangDependencyScanning PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangDependencyScanning.dll"
  )
...
set_target_properties(clangTransformer PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTransformer.dll"
  )
...
set_target_properties(clangTooling PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTooling.dll"
  )
...
set_target_properties(clangDirectoryWatcher PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangDirectoryWatcher.dll"
  )
...
set_target_properties(clangIndex PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangIndex.dll"
  )
...
set_target_properties(clangIndexSerialization PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangIndexSerialization.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangBasic;LLVMSupport"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangIndexSerialization.dll"
  )
...
set_target_properties(clangStaticAnalyzerCore PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangStaticAnalyzerCore.dll"
  )
...
set_target_properties(clangStaticAnalyzerCheckers PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangStaticAnalyzerCheckers.dll"
  )
...
set_target_properties(clangStaticAnalyzerFrontend PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangStaticAnalyzerFrontend.dll"
  )
...
set_target_properties(clangFormat PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangFormat.dll"
  )
...
set_target_properties(clangTesting PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTesting.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVMSupport"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTesting.dll"
  )
...
set_target_properties(clangHandleCXX PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangHandleCXX.dll"
  )
...
set_target_properties(clangHandleLLVM PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangHandleLLVM.dll"
  )
...
set_target_properties(clangApplyReplacements PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangApplyReplacements.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangApplyReplacements.dll"
  )
...
set_target_properties(clangReorderFields PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangReorderFields.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangReorderFields.dll"
  )
...
set_target_properties(clangTidy PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidy.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVMFrontendOpenMP;LLVMSupport;clangAnalysis;clangAST;clangASTMatchers;clangBasic;clangFormat;clangFrontend;clangLex;clangRewrite;clangSema;clangSerialization;clangTooling;clangToolingCore;clangStaticAnalyzerCore;clangStaticAnalyzerFrontend"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidy.dll"
  )
...
set_target_properties(clangTidyAndroidModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyAndroidModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyAndroidModule.dll"
  )
...
set_target_properties(clangTidyAbseilModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyAbseilModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyAbseilModule.dll"
  )
...
set_target_properties(clangTidyAlteraModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyAlteraModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyAlteraModule.dll"
  )
...
set_target_properties(clangTidyBoostModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyBoostModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyUtils;LLVMSupport;LLVMFrontendOpenMP;clangAST;clangASTMatchers;clangBasic;clangLex"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyBoostModule.dll"
  )
...
set_target_properties(clangTidyBugproneModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyBugproneModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyCppCoreGuidelinesModule;clangTidyUtils;LLVMSupport;LLVMFrontendOpenMP;clangAnalysis;clangAST;clangASTMatchers;clangBasic;clangLex;clangTooling"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyBugproneModule.dll"
  )
...
set_target_properties(clangTidyCERTModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyCERTModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyBugproneModule;clangTidyGoogleModule;clangTidyMiscModule;clangTidyPerformanceModule;clangTidyReadabilityModule;clangTidyUtils;LLVMSupport;LLVMFrontendOpenMP;clangAST;clangASTMatchers;clangBasic;clangLex"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyCERTModule.dll"
  )
...
set_target_properties(clangTidyConcurrencyModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyConcurrencyModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyConcurrencyModule.dll"
  )
...
set_target_properties(clangTidyCppCoreGuidelinesModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyCppCoreGuidelinesModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyMiscModule;clangTidyModernizeModule;clangTidyReadabilityModule;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAST;clangASTMatchers;clangBasic;clangLex;clangSerialization;clangTooling"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyCppCoreGuidelinesModule.dll"
  )
...
set_target_properties(clangTidyDarwinModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyDarwinModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAnalysis;clangAST;clangASTMatchers;clangBasic;clangLex"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyDarwinModule.dll"
  )
...
set_target_properties(clangTidyFuchsiaModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyFuchsiaModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyFuchsiaModule.dll"
  )
...
set_target_properties(clangTidyGoogleModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyGoogleModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyGoogleModule.dll"
  )
...
set_target_properties(clangTidyHICPPModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyHICPPModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyHICPPModule.dll"
  )
...
set_target_properties(clangTidyLinuxKernelModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyLinuxKernelModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyLinuxKernelModule.dll"
  )
...
set_target_properties(clangTidyLLVMModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyLLVMModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyLLVMModule.dll"
  )
...
set_target_properties(clangTidyLLVMLibcModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyLLVMLibcModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyLLVMLibcModule.dll"
  )
...
set_target_properties(clangTidyMiscModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyMiscModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAnalysis;clangAST;clangASTMatchers;clangBasic;clangLex;clangSerialization;clangTooling"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyMiscModule.dll"
  )
...
set_target_properties(clangTidyModernizeModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyModernizeModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyReadabilityModule;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAST;clangASTMatchers;clangBasic;clangLex;clangTooling"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyModernizeModule.dll"
  )
...
set_target_properties(clangTidyMPIModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyMPIModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyMPIModule.dll"
  )
...
set_target_properties(clangTidyObjCModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyObjCModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAST;clangASTMatchers;clangBasic;clangLex"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyObjCModule.dll"
  )
...
set_target_properties(clangTidyOpenMPModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyOpenMPModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyOpenMPModule.dll"
  )
...
set_target_properties(clangTidyPerformanceModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyPerformanceModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyPerformanceModule.dll"
  )
...
set_target_properties(clangTidyPortabilityModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyPortabilityModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAST;clangASTMatchers;clangBasic;clangLex;clangTooling"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyPortabilityModule.dll"
  )
...
set_target_properties(clangTidyReadabilityModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyReadabilityModule.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyReadabilityModule.dll"
  )
...
set_target_properties(clangTidyZirconModule PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyZirconModule.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;clangAST;clangASTMatchers;clangBasic;clangLex"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyZirconModule.dll"
  )
...
set_target_properties(clangTidyPlugin PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyPlugin.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyPlugin.dll"
  )
...
set_target_properties(clangTidyUtils PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangTidyUtils.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangTidy;LLVMFrontendOpenMP;LLVMSupport;clangAST;clangASTMatchers;clangBasic;clangLex;clangSema;clangTransformer"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangTidyUtils.dll"
  )
...
set_target_properties(clangChangeNamespace PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangChangeNamespace.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangChangeNamespace.dll"
  )
...
set_target_properties(clangDoc PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangDoc.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVMSupport;LLVMBitstreamReader;LLVMFrontendOpenMP;clangAnalysis;clangAST;clangASTMatchers;clangBasic;clangFrontend;clangIndex;clangLex;clangTooling;clangToolingCore"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangDoc.dll"
  )
...
set_target_properties(clangIncludeFixer PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangIncludeFixer.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangIncludeFixer.dll"
  )
...
set_target_properties(clangIncludeFixerPlugin PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangIncludeFixerPlugin.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangIncludeFixerPlugin.dll"
  )
...
set_target_properties(findAllSymbols PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libfindAllSymbols.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libfindAllSymbols.dll"
  )
...
set_target_properties(clangMove PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangMove.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangMove.dll"
  )
...
set_target_properties(clangQuery PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangQuery.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangQuery.dll"
  )
...
set_target_properties(clangdSupport PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangdSupport.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "LLVMSupport"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangdSupport.dll"
  )
...
set_target_properties(clangDaemonTweaks PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangDaemonTweaks.dll.a"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangAST;clangBasic;clangDaemon;clangdSupport;clangFormat;clangLex;clangToolingCore;clangToolingRefactoring;clangToolingSyntax;LLVMSupport"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangDaemonTweaks.dll"
  )
...
set_target_properties(clangdRemoteIndex PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/libclangdRemoteIndex.dll.a"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libclangdRemoteIndex.dll"
  )
...
set_target_properties(libclang PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "clangAST;clangBasic;clangDriver;clangFrontend;clangIndex;clangLex;clangRewrite;clangSema;clangSerialization;clangTooling;clangARCMigrate;LLVMAArch64CodeGen;LLVMAArch64AsmParser;LLVMAArch64Desc;LLVMAArch64Disassembler;LLVMAArch64Info;LLVMAArch64Utils;LLVMAMDGPUCodeGen;LLVMAMDGPUAsmParser;LLVMAMDGPUDesc;LLVMAMDGPUDisassembler;LLVMAMDGPUInfo;LLVMAMDGPUUtils;LLVMARMCodeGen;LLVMARMAsmParser;LLVMARMDesc;LLVMARMDisassembler;LLVMARMInfo;LLVMARMUtils;LLVMAVRCodeGen;LLVMAVRAsmParser;LLVMAVRDesc;LLVMAVRDisassembler;LLVMAVRInfo;LLVMBPFCodeGen;LLVMBPFAsmParser;LLVMBPFDesc;LLVMBPFDisassembler;LLVMBPFInfo;LLVMHexagonCodeGen;LLVMHexagonAsmParser;LLVMHexagonDesc;LLVMHexagonDisassembler;LLVMHexagonInfo;LLVMLanaiCodeGen;LLVMLanaiAsmParser;LLVMLanaiDesc;LLVMLanaiDisassembler;LLVMLanaiInfo;LLVMMipsCodeGen;LLVMMipsAsmParser;LLVMMipsDesc;LLVMMipsDisassembler;LLVMMipsInfo;LLVMMSP430CodeGen;LLVMMSP430AsmParser;LLVMMSP430Desc;LLVMMSP430Disassembler;LLVMMSP430Info;LLVMNVPTXCodeGen;LLVMNVPTXDesc;LLVMNVPTXInfo;LLVMPowerPCCodeGen;LLVMPowerPCAsmParser;LLVMPowerPCDesc;LLVMPowerPCDisassembler;LLVMPowerPCInfo;LLVMRISCVCodeGen;LLVMRISCVAsmParser;LLVMRISCVDesc;LLVMRISCVDisassembler;LLVMRISCVInfo;LLVMSparcCodeGen;LLVMSparcAsmParser;LLVMSparcDesc;LLVMSparcDisassembler;LLVMSparcInfo;LLVMSystemZCodeGen;LLVMSystemZAsmParser;LLVMSystemZDesc;LLVMSystemZDisassembler;LLVMSystemZInfo;LLVMWebAssemblyCodeGen;LLVMWebAssemblyAsmParser;LLVMWebAssemblyDesc;LLVMWebAssemblyDisassembler;LLVMWebAssemblyInfo;LLVMX86CodeGen;LLVMX86AsmParser;LLVMX86Desc;LLVMX86Disassembler;LLVMX86Info;LLVMXCoreCodeGen;LLVMXCoreDesc;LLVMXCoreDisassembler;LLVMXCoreInfo;LLVMCore;LLVMSupport"
